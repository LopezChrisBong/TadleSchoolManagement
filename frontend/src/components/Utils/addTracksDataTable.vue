<template>
  <div>
    ...
    <AddTrackDialog :data="tracksData" :action="action" :grade="gradeName" />
...
import AddTrackDialog from "../../components/Dialogs/Forms/AddTrackDialog.vue";
export default {
  components: {
  ...
  methods: {
    ...
    add() {
      this.tracksData = [{ id: null }];
      this.action = "Add";
    },
    editItem(item) {
      console.log(this.tab, item);
      this.tracksData = item;
      this.action = "Update";
    },
