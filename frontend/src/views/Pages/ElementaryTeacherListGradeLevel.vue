    ...
    <v-card class="mt-2">
      <v-row>
        <v-col cols="12">
          ...
          <ElementaryTeacherListGradeLevelDataTabale />
        </v-col>
      </v-row>
    </v-card>
  </div>
...
<script>
import ElementaryTeacherListGradeLevelDataTabale from "../../components/Utils/ElementaryTeacherListGradeLevelDataTabale.vue";
export default {
  components: {
    ElementaryTeacherListGradeLevelDataTabale,
  },
