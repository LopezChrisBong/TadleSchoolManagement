...
import { Availability, EnrollStudent, SchoolYear, StudentList, StudentValues } from 'src/entities';
import { TypeOrmModule } from '@nestjs/typeorm';

@Module({
  imports: [TypeOrmModule.forFeature([EnrollStudent, Availability, SchoolYear,StudentValues, StudentList])],
