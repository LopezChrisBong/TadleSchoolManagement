...
import { AddStrand, AddTracks, EnrollStudent, RoomsSection, SchoolYear, StudentList, UserDetail,StudentAttendance,StudentGrade, TransmutedGrade,StudentQuarterFinalGrade, ParentRecord, Subject, LardoStudentNotification, AtRiskStudentNotification, Notification, LardoStudentForFacultyNotification, AtRiskStudentForFacultyNotification } from 'src/entities';
...
export class NotificationService {
  ...
  updateLardoAdviser(id: number, updateLardoStudentNotificationDto: UpdateLardoStudentNotificationDto) {
  try {
  ...
  updateLardoFaculty(id: number, updateLardoStudentForFacultyNotificationDto: UpdateLardoStudentForFacultyNotificationDto) {
  try {
  ...
  updateAtRiskAdviser(id: number, updateAtRiskStudentNotificationDto: UpdateAtRiskStudentNotificationDto) {
  try {
  ...
  updateAtRiskFaculty(id: number, updateAtRiskStudentForFacultyNotificationDto: UpdateAtRiskStudentForFacultyNotificationDto) {
  try {
